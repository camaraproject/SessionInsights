Feature: CAMARA Session Insights API, v0.1.0-alpha.1 - Operation sendSessionMetrics
  ...
  Background: Common sendSessionMetrics setup
    ...
    And the resource "/session-insights/v0.1alpha1/sessions/{sessionId}/metrics"
